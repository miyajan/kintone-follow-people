...
function main(argv, console, exit) {
    ...
    program
        ...
        .option('-i, --includes <codes>', 'Follow only specified users. Comma separeted list of login name.', separate)
    ...
    const includes = program.includes || config.includes;
    ...
    followPeople(fqdn, username, password, excludes, includes).then(users => {
